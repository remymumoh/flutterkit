...
Future<List<ContentModel>> getContents(context) async {
  ...
  var cat1tem10 = ContentModel(
      title: 'Fingerprint Authentication',
      pageName: FingerprintAuthentication());

  list.add(ContentModel(
      title: 'Integrations',
      subTitle: 'Ready-made code',
      bgColor: appCat1,
      items: [
        cat1Item1,
        cat1Item2,
  ...
  var cat2Item1 = ContentModel(
      title: 'Custom Buttons', bgColor: appCat4, pageName: ButtonScreen());
  var cat2Item2 = ContentModel(
      title: 'Pickers', bgColor: appCat6, pageName: PickerScreen());
