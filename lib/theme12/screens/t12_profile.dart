                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      ...
                      Expanded(child: text("(" + (position + 1).toString() + "/" + cards.length.toString() + ")",textColor: appStore.textSecondaryColor, fontSize: textSizeMedium, fontFamily: fontMedium).paddingLeft(spacing_control)),
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      ...
                      Expanded(child: text("(" + (ac_position + 1).toString() + "/2)",textColor: appStore.textSecondaryColor, fontSize: textSizeMedium, fontFamily: fontMedium).paddingLeft(spacing_control)),
                      Icon(Icons.add_circle_outline, size: 20, color: t12_primary_color)
                    ],
                  ).paddingAll(spacing_standard_new),
                  Container(
