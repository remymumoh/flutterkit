                                                    ...
                                                    builder: (BuildContext context) {
                                                      return Container(
                                                        decoration: BoxDecoration(
                                                            color: Colors.white,
                                                            borderRadius:
                                                                BorderRadius.only(topLeft: Radius.circular(spacing_standard), topRight: Radius.circular(spacing_standard))),
                                                        child: Column(
                                                          children: <Widget>[
                                                            Container(
                                                              width: double.infinity,
                                                                    ...
                                                                    child: Column(
                                                                      children: <Widget>[
                                                                        ...
                                                                        text("Electricity Bill",
                                                                                fontSize: textSizeMedium, textColor: t12_text_color_primary, fontFamily: fontMedium)
                                                                            .paddingTop(spacing_control_half),
                                                                      ],
                                                                    ),
                                                                  ),
