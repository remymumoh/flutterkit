                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    text(durationFormatter(_currentPosition) + " / " + durationFormatter(_duration), textColor: muvi_textColorPrimary)
            ...
            return Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  text(actors[index].title, textColor: muvi_textColorPrimary, fontFamily: font_medium, maxLine: 2, isCentered: true)
