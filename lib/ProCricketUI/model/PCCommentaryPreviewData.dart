class PCCommentaryPreviewData {
  ...
  PCCommentaryPreviewData({this.alerts, this.burst_cache, this.burst_cache_id, this.burst_cache_time, this.comm_lines, this.data_path, this.header, this.match_id, this.pulltoRefreshStopRate, this.range, this.series_id, this.series_name, this.venue});
