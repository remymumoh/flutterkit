      ...
      decoration: InputDecoration(
        suffixIcon: widget.isSecure
            ? GestureDetector(
                ...
                child: new Icon(widget.isPassword ? Icons.visibility : Icons.visibility_off,color: appStore.iconColor,),
              )
            : null,
...
class PinEntryTextField extends StatefulWidget {
  ...
  PinEntryTextField({this.lastPin, this.fields: 4, this.onSubmit, this.fieldWidth: 40.0, this.fontSize: 20.0, this.isTextObscure: false, this.showFieldAsBox: false})
      : assert(fields > 0);
