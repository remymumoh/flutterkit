  ...
  return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            decoration: BoxDecoration(
                borderRadius: BorderRadius.only(bottomLeft: Radius.circular(spacing_standard_new), bottomRight: Radius.circular(spacing_standard_new)), color: qIBus_color_check),
            width: MediaQuery.of(context).size.width,
