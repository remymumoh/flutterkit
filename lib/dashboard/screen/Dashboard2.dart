                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          Text(db2_lbl_home,style: boldTextStyle(size: 20,color: white),),
                        ],
                      ),
                      Row(
                        children: <Widget>[
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(db2_lbl_offers, style: primaryTextStyle(size: 20, fontFamily: fontMedium),),
                    ),
                    Container(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Text(model.name),
                Text("\$100", style: primaryTextStyle(color: db2_textColorSecondary, fontFamily: fontMedium),),
              ],
            ),
          )
        ],
