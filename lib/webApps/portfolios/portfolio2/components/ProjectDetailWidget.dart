    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Passionate designer & developer who loves simplicity.', style: boldTextStyle(size: 32),textAlign: TextAlign.center,),
          8.height,
          ...
          Text(
              ...
              textAlign: TextAlign.center).withWidth(context.width() * 0.7),
          24.height,
          FlatButton(
            onPressed: () {},
