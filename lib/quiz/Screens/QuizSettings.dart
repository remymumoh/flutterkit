...
class _QuizSettingsState extends State<QuizSettings> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(quiz_lbl_setting, style: primaryTextStyle(size: 18, fontFamily: fontMedium),),
        leading: Icon(
          Icons.arrow_back,
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(quiz_lbl_logout, style: boldTextStyle(color: quiz_colorPrimary, size: 18),).paddingAll(16).onTap(() {
                      finish(context);
                    })
                  ],
                ),
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[Text(heading), Text(info, style: primaryTextStyle(color: quiz_textColorSecondary, size: 14),)],
            ),
          ],
        ),
        Icon(
