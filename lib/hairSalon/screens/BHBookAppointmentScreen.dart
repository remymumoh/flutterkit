                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          BHTxtChooseSpecialList,
                          style: TextStyle(fontSize: 14, color: BHAppTextColorPrimary, fontWeight: FontWeight.bold),
                        ),
                        Text(
                          BHTxtHairStylists,
                          style: TextStyle(color: BHColorPrimary, fontSize: 14, fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                    8.height,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                'Services',
                style: TextStyle(color: BHAppTextColorPrimary, fontWeight: FontWeight.bold),
              ),
              Container(
                margin: EdgeInsets.only(top: 8),
                color: whiteColor,
